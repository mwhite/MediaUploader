hqDefine("hqmedia/MediaUploader/hqmedia.upload_controller", [
    'jquery',
    'underscore',
], function(
    $,
    ...
    return {
        HQMediaUploaderTypes: HQMediaUploaderTypes,
        HQMediaFileUploadController: HQMediaFileUploadController,
    };
});
